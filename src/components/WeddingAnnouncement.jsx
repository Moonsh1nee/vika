...
export default function WeddingAnnouncement() {
  ...
  return (
    <section className="bg-marble">
      <div className="flex min-h-[70vh] flex-col md:flex-row max-w-7xl mx-auto">
        ...
        <div className="relative isolate flex min-h-80 flex-1 items-center overflow-hidden py-16 pl-0 pr-6 md:min-h-[70vh] md:py-20 md:pr-10">
          <p
